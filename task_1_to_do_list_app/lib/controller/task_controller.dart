...
import 'package:task_1_to_do_list_app/Model/task_model.dart';
...
class TaskController extends GetxController {
  ...
  void loadTasks() async {
    ...
    filteredList.assignAll((taskList
        .where(
            (task) => task.date == DateFormat.yMd().format(_selectedDate.value))
        .toList()));
    print(
        'length is ${taskList.length} and filter list length is ${filteredList.length}');
  }
}
